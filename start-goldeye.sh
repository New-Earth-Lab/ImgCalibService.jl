...
julia +1.10 --project=/opt/spiders/imgcalibservice/ --threads 1,1 --gcthreads=1 -e "using ImgCalib; ImgCalib.main(ARGS)" -- ${1:-/opt/spiders/imgcalibservice/goldeye-config.toml}
